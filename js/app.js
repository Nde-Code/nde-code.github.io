    ...
    <div class="modalbox-class" id="modalbox-notes" role="dialog">
        ...
        <div class="modalbox-main-container">
            ...
            <div class="modalbox-text-container">
                ...
                <p class="modalbox-description"><i class="fa-solid fa-square point"></i> <strong>Ace.js:</strong> un petit éditeur de code écrit en JavaScript, accompagné des compléments nécessaires, notamment un ou plusieurs thèmes ainsi qu'une ou plusieurs colorations syntaxiques. </p>
            ...
            <div class="modalbox-text-container">
                ...
                <p class="modalbox-description">Bien que je ne voie pas trop l'intérêt de reprendre l'intégralité du code de mon site pour le réutiliser tel quel, j'ai tout de même décidé de le placer sous <span class="color-green">une licence permissive</span> mais <span class="color-red">pas trop non plus</span> (ça reste à la base un site personnel, entièrement codé à la main, sans aucun outil). Si vous souhaitez simplement <span class="color-green">reprendre quelques morceaux de code ou des éléments de style</span>, pas de souci. En revanche, pour <span class="color-red">une réutilisation plus large ou complète</span>, merci de me contacter au préalable pour qu'on en discute. Voici la licence: </p>
