  ...
  collabs: [
    {
      ...
      status: 'COMPLETED',
      description:
        'A GDPR-oriented facial recognition attendance system focused on privacy and security. The project uses InsightFace for facial embedding extraction, allowing identity verification through secure similarity matching rather than raw image storage. Built with Django for the web platform and Flask for the Raspberry Pi client (see Amory707/BioAttendFront on GitHub), which performs real-time face processing and integrates an AI-based anti-spoofing model. Supabase is used as the backend database to securely manage biometric embeddings, user accounts, attendance records, statistics, and related data.',
      contributions: [
